...
var BufferLayout = require('@solarti/buffer-layout');
...
class Struct {
  ...
  encode() {
    return buffer.Buffer.from(borsh.serialize(MIRALAND_SCHEMA, this));
  }
  static decode(data) {
    return borsh.deserialize(MIRALAND_SCHEMA, this, data);
  }
  static decodeUnchecked(data) {
    return borsh.deserializeUnchecked(MIRALAND_SCHEMA, this, data);
  }
}
...
var relative = require$$0__default$3["default"].relative;
...
class HttpsAgent$1 extends HttpAgent {
  constructor(options) {
    super(options);
...
const MiralandJSONRPCErrorCode = {
...
class MiralandJSONRPCError extends Error {
  constructor({
    code,
    message,
    data
...
const VersionResult = superstruct.type({
  'miraland-core': superstruct.string(),
...
class Connection {
  ...
  async getBalanceAndContext(publicKey, commitmentOrConfig) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `failed to get balance for ${publicKey.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getBlockTime(slot) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `failed to get block time for slot ${slot}`);
    }
    return res.result;
  }
  ...
  async getMinimumLedgerSlot() {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get minimum ledger slot');
    }
    return res.result;
  }
  ...
  async getFirstAvailableBlock() {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get first available block');
    }
    return res.result;
  }
  ...
  async getTokenAccountBalance(tokenAddress, commitment) {
    ...
    const res = superstruct.create(unsafeRes, jsonRpcResultAndContext(TokenAmountResult));
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get token account balance');
    }
    return res.result;
  }
  ...
  async getTokenAccountsByOwner(ownerAddress, filter, commitmentOrConfig) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `failed to get token accounts owned by account ${ownerAddress.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getTokenLargestAccounts(mintAddress, commitment) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get token largest accounts');
    }
    return res.result;
  }
  ...
  async getAccountInfoAndContext(publicKey, commitmentOrConfig) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `failed to get info about account ${publicKey.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getMultipleParsedAccounts(publicKeys, rawConfig) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `failed to get info for accounts ${keys}`);
    }
    return res.result;
  }
  ...
  async getStakeActivation(publicKey, commitmentOrConfig, epoch) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `failed to get Stake Activation ${publicKey.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getProgramAccounts(programId, configOrCommitment) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `failed to get accounts owned by program ${programId.toBase58()}`);
    }
    return res.result;
  }
  ...
  async getTransactionCount(commitmentOrConfig) {
    ...
    const res = superstruct.create(unsafeRes, jsonRpcResult(superstruct.number()));
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get transaction count');
    }
    return res.result;
  }
  ...
  async getRecentPerformanceSamples(limit) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get recent performance samples');
    }
    return res.result;
  }
  ...
  async getBlock(slot, rawConfig) {
    ...
    try {
      ...
      throw new MiralandJSONRPCError(e, 'failed to get confirmed block');
    }
  }
  ...
  async getParsedBlock(slot, rawConfig) {
    ...
    try {
      ...
      throw new MiralandJSONRPCError(e, 'failed to get block');
    }
  }
  ...
  async getBlockHeight(commitmentOrConfig) {
    ...
    const res = superstruct.create(unsafeRes, jsonRpcResult(superstruct.number()));
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get block height information');
    }
    return res.result;
  }
  ...
  async getBlockProduction(configOrCommitment) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get block production information');
    }
    return res.result;
  }
  ...
  async getParsedConfirmedTransaction(signature, commitment) {
    ...
    const res = superstruct.create(unsafeRes, GetParsedTransactionRpcResult);
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get confirmed transaction');
    }
    return res.result;
  }
  ...
  async getParsedConfirmedTransactions(signatures, commitment) {
    ...
    const res = unsafeRes.map(unsafeRes => {
      const res = superstruct.create(unsafeRes, GetParsedTransactionRpcResult);
      if ('error' in res) {
        throw new MiralandJSONRPCError(res.error, 'failed to get confirmed transactions');
      }
      return res.result;
    });
    return res;
  ...
  async getConfirmedSignaturesForAddress2(address, options, commitment) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get confirmed signatures for address');
    }
    return res.result;
  }
  ...
  async getSignaturesForAddress(address, options, commitment) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, 'failed to get signatures for address');
    }
    return res.result;
  }
  ...
  async requestAirdrop(to, lamports) {
    ...
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `airdrop to ${to.toBase58()} failed`);
    }
    return res.result;
  }
  ...
  async getStakeMinimumDelegation(config) {
    ...
    const res = superstruct.create(unsafeRes, jsonRpcResultAndContext(superstruct.number()));
    if ('error' in res) {
      throw new MiralandJSONRPCError(res.error, `failed to get stake minimum delegation`);
    }
    return res.result;
  }
 ...
 */
const LAMPORTS_PER_SLRT = 1000000000;
/**
 * There are 1-billion lamports in one QTH
 */
const LAMPORTS_PER_QTH = 1000000000;
/**
 * There are 1-billion lamports in one MIRA
 */
const LAMPORTS_PER_MIRA = 1000000000;
/**
 * There are 1-billion lamports in one MLN
 */
const LAMPORTS_PER_MLN = 1000000000;
...
exports.LAMPORTS_PER_MIRA = LAMPORTS_PER_MIRA;
exports.LAMPORTS_PER_MLN = LAMPORTS_PER_MLN;
exports.LAMPORTS_PER_QTH = LAMPORTS_PER_QTH;
exports.LAMPORTS_PER_SLRT = LAMPORTS_PER_SLRT;
exports.LAMPORTS_PER_SOL = LAMPORTS_PER_SOL;
exports.LOOKUP_TABLE_INSTRUCTION_LAYOUTS = LOOKUP_TABLE_INSTRUCTION_LAYOUTS;
exports.Loader = Loader;
exports.Lockup = Lockup;
exports.MAX_SEED_LENGTH = MAX_SEED_LENGTH;
exports.MIRALAND_SCHEMA = MIRALAND_SCHEMA;
exports.Message = Message;
exports.MessageAccountKeys = MessageAccountKeys;
exports.MessageV0 = MessageV0;
exports.MiralandJSONRPCError = MiralandJSONRPCError;
exports.MiralandJSONRPCErrorCode = MiralandJSONRPCErrorCode;
