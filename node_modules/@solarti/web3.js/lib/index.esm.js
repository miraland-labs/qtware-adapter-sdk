...
const COMMON_HTTP_HEADERS = {
  'solana-client': `js/${(_process$env$npm_pack = "0.1.4") !== null && _process$env$npm_pack !== void 0 ? _process$env$npm_pack : 'UNKNOWN'}`
};
/**
...
class Connection {
   ...
   *
   * (async () => {
   *   const connection = new Connection("https://api.testnet-mln.solarti.com", "confirmed");
...
const LAMPORTS_PER_SOL = 1000000000; // m17: SLRT, QTH, MIRA, MLN
