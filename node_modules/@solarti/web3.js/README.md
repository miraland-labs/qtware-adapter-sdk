...
[travis-image]: https://api.travis-ci.org/miraland-labs/solarti-web3.js.svg?branch=master
[travis-url]: https://travis-ci.org/miraland-labs/solarti-web3.js
...
# Solarti Extension to Solana JavaScript API

This is the Solarti extension to Solana Javascript API built on the Solana [JSON RPC API](https://docs.solana.com/apps/jsonrpc-api)

## Documentation and examples

 - [The Solana Cookbook](https://solanacookbook.com/) has extensive task-based documentation using solana library.
 - For more detail on individual functions, see the [latest API Documentation](https://solana-labs.github.io/solana-web3.js/). 
 - This library has the same usage as solana equivalent.
...
```ini
[libs]
node_modules/@solarti/web3.js/module.flow.js
```
...
If you have an issue to report or would like to contribute a pull request, please do so against the monorepo at https://github.com/miraland-labs/solarti. We are not able to merge pull requests into the mirror repo https://github.com/miraland-labs/solarti-web3.js and issues filed there may go unnoticed.
