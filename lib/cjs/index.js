...
const web_js_1 = __importDefault(require("./adapters/web.js"));
const extension_js_1 = __importDefault(require("./adapters/extension.js"));
class Qtware extends eventemitter3_1.default {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const AdapterClass = typeof this._provider === 'string' ? web_js_1.default : extension_js_1.default;
